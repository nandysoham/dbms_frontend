...
const SignupPageSeller = () => {
    ...
    const submitsignup = async (profilePictures)=>{
        ...
        formData.append('companyname', signup.companyname);
        formData.append('companyid', signup.companyid)
        ...
        const response = await fetch(process.env.REACT_APP_BACKENDURL + "/api/createseller",{
        ...
        <div className="container my-4" style={{}}>
            ...
            <form onSubmit={handleClick}>
                ...
                <div class="form-group col-md-4 my-2">
                    ...
                    <input onChange={onChange} type="text" class="form-control" id="inputCompanyName" placeholder="MS Traders" name="companyname" />
                </div>
                <div class="form-group col-md-4 my-2">
                    <label for="inputAddress2">Company ID</label>
                    <input onChange={onChange} type="text" class="form-control" id="inputCompanyId" placeholder="XXXXX" name="companyid" />
                </div>
